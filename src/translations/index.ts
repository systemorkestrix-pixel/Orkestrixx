...
const translations: Record<TranslationKey, { fr: string; ar: string }> = {
  ...
  'hero.description': { fr: "POS rapide, stock en temps réel, rapports clairs. Licence à vie, paiement unique.", ar: 'نقطة بيع سريعة، مخزون فوري، تقارير واضحة. رخصة مدى الحياة، دفعة واحدة.' },
  ...
  'whatYouCanDo.item2Title': { fr: 'Suivre le stock en temps réel', ar: 'تتبع المخزون فورياً' },
  ...
  'screenshots.altReports': { fr: 'Rapports et analyses', ar: 'التقارير والتحليلات' },
  ...
  'pricing.paymentText': { fr: 'Après validation, votre licence vous est envoyée.', ar: 'بعد التأكيد، يتم إرسال رخصتك.' },
  ...
  'purchaseProcess.step5Desc': { fr: 'Votre clé de licence vous est envoyée par e-mail. Conservez-la précieusement — elle est liée à votre installation.', ar: 'يُرسل مفتاح الترخيص إلى بريدك الإلكتروني. احتفظ به — إنه مرتبط بتثبيتك.' },
  'purchaseProcess.step6Title': { fr: 'Activation du logiciel', ar: 'تفعيل البرنامج' },
  'purchaseProcess.step6Desc': { fr: 'Saisissez votre clé de licence dans le logiciel pour activer votre version définitive. Licence à vie, sans abonnement.', ar: 'أدخل مفتاح الترخيص في البرنامج لتفعيل النسخة النهائية. رخصة مدى الحياة.' },
  ...
  'privacy.s2Li1': { fr: "Exécution contractuelle : pour la gestion des licences et l'envoi des clés d'activation", ar: 'التنفيذ التعاقدي : لإدارة التراخيص وإرسال مفاتيح التفعيل' },
  ...
  'privacy.s3Li1': { fr: 'Gestion des commandes et délivrance des licences', ar: 'إدارة الطلبات وتسليم التراخيص' },
  ...
  'cgv.s2Li2': { fr: 'Gestion des stocks en temps réel', ar: 'إدارة المخزون فورياً' },
  'cgv.s2Li3': { fr: 'Gestion des achats et fournisseurs', ar: 'إدارة المشتريات والموردين' },
  'cgv.s2Li4': { fr: 'Rapports et analyses', ar: 'التقارير والتحليلات' },
  ...
  'cgv.s6Li4': { fr: "Validation : Après vérification du paiement, l'Éditeur délivre la clé de licence au Client par e-mail.", ar: 'التأكيد : بعد التحقق من الدفع، يسلم الناشر مفتاح الترخيص للعميل عبر البريد الإلكتروني.' },
  'cgv.s6Li5': { fr: "Activation : Le Client active sa licence dans le Logiciel à l'aide de la clé reçue.", ar: 'التفعيل : يقوم العميل بتفعيل رخصته في البرنامج باستخدام المفتاح المستلم.' },
  ...
  'cgv.s7Li1': { fr: "Paiements par carte ou PayPal : la clé de licence est délivrée automatiquement après confirmation du paiement", ar: 'الدفع بالبطاقة أو باي بال : يُسلم مفتاح الترخيص تلقائياً بعد تأكيد الدفع' },
  'cgv.s7Li2': { fr: "Paiements locaux (BaridiMob, CCP) : la clé de licence est envoyée par e-mail dans un délai maximum de 48 heures ouvrées après confirmation du virement", ar: 'الدفعات المحلية (باريدي موب، سي سي بي) : يُرسل مفتاح الترخيص عبر البريد الإلكتروني في غضون 48 ساعة عمل بعد تأكيد التحويل' },
  'cgv.s7Li3': { fr: "Binance Pay : la clé est envoyée après confirmation de la transaction", ar: 'بينانس باي : يُرسل المفتاح بعد تأكيد المعاملة' },
  ...
  'cgv.s11Li2': { fr: "Ne pas partager sa clé de licence avec des tiers non autorisés", ar: 'عدم مشاركة مفتاح الترخيص مع أطراف ثالثة غير مصرح بها' },
  ...
  'features.item2Desc': { fr: 'Ventes, marges et performances en un coup d\'œil.', ar: 'المبيعات والهوامش والأداء بنظرة واحدة.' },
  ...
  'features.item4Title': { fr: 'Activité en temps réel', ar: 'نشاط فوري' },
  'features.item4Desc': { fr: 'Transactions en direct : ventes, achats, stock.', ar: 'المعاملات مباشرة: مبيعات، مشتريات، مخزون.' },
  'features.item5Title': { fr: 'Rapports', ar: 'التقارير' },
  'features.item5Desc': { fr: 'Export PDF et Excel de vos données.', ar: 'تصدير بياناتك إلى PDF أو Excel.' },
